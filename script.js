...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const startMessage = "Click To View";
  ...
  const bioMessages = [
    "Yes I Made This... Socials Below, Fu*k guns.lol they keep banning my shit. If u want a custom link ill send you the src just dm me.",
    "\"Hello, World!\""
  ];
  let bioText = '';
  let bioIndex = 0;
